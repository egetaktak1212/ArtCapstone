...
MODEL_PATH    = "ArtCapstone/keypoints/best_landmark_model.pth"
IMAGES_PATH   = "ArtCapstone/keypoints/image/cameron.JPG"
DB_PATH       = "ArtCapstone/keypoints/aflw.sqlite"
IMG_SIZE      = 128
NUM_LANDMARKS = 21
...
run_everything("ArtCapstone/keypoints/image/cameron.JPG")